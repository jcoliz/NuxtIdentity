...
/// <remarks>
/// This implementation stores all notification data in memory, allowing test code to retrieve
/// reset codes and confirmation codes that were sent during a test run. Register this as a
/// singleton in test environments so all requests share the same notification store.
///
